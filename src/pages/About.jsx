...
const About = () => {
    return (
      <div className='w-full mt-[100px] text-white '>
        {/* section 1 */}
        <section >
          <div className='w-[80%] mx-auto mb-12 flex flex-col gap-y-6'>
              <header>
                  Driving Innovation in Online Education for a 
                  <HighlightText text={"Brighter Future"}/>
                  <p className='mt-6'>Studynotion is at the forefront of driving innovation in online education. We're passionate about creating a brighter future by offering cutting-edge courses, leveraging emerging technologies, and nurturing a vibrant learning community.</p>
              </header>
        ...
        <section>
          <div className='flex flex-col w-[80%] mx-auto gap-y-16 mb-12'>
              {/* foudning story wala div */}
              <div className='flex '>
                  {/* founding story left box */}
                  <div>
                      <h1 className='text-[24px] text-richblue-100 font-bold'>Our Founding Story</h1>
              ...
              <div className='flex'>
                  {/* left box */}
                  <div>
                      <h1 className='text-[24px] text-richblue-100 font-bold'>Our Vision</h1>
